...
export function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose dark:prose-invert prose-headings:font-display prose-headings:font-bold prose-a:text-primary max-w-none focus:outline-none min-h-[300px] px-4 py-3",
      },
    },
  });
  ...
  const Divider = () => <div className="bg-border mx-1 h-5 w-px" />;

  return (
    <div className="border-border bg-card overflow-hidden rounded-lg border">
      <div className="border-border bg-muted/30 flex flex-wrap items-center gap-0.5 border-b p-2">
        <ToolbarButton
